...
// Quantum certified set 1.30.0 — every suite module below is pinned to the
...
require (
	...
	github.com/jcsvwinston/nucleus/drivers/mysql v0.1.4
	github.com/jcsvwinston/nucleus/drivers/postgres v0.1.4
	github.com/jcsvwinston/nucleus/exporters/prometheus v0.1.4
	github.com/jcsvwinston/nucleus/providers/storage-s3 v0.1.4
