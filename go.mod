...
require (
	...
	github.com/jcsvwinston/nucleus/drivers/mysql v0.1.2
	github.com/jcsvwinston/nucleus/drivers/postgres v0.1.2
	github.com/jcsvwinston/nucleus/exporters/prometheus v0.1.2
	github.com/jcsvwinston/nucleus/providers/storage-s3 v0.1.2
	github.com/jcsvwinston/quark/drivers/mysql v0.1.2
	github.com/jcsvwinston/quark/drivers/postgres v0.1.2
